...
static type_param_t *add_type_param(type_param_t *head,
...
static unsigned int parse_variable_with_hint(const char *err,
                                             type_hint_t hint) {
  consume(TOK_IDENT, err);
